...
public class OrderShipperAdapter extends RecyclerView.Adapter<OrderShipperAdapter.ViewHolder> {
    List<Order> orders;
    Context context;
    APIService apiService;

    public OrderShipperAdapter(List<Order> orders, Context context) {
        this.orders = orders;
