...
public class VendorOrderDangGAdapter extends RecyclerView.Adapter<VendorOrderDangGAdapter.ViewHolder> {
    List<Order> orders, check;
    Context context;
    APIService apiService;

    public VendorOrderDangGAdapter(List<Order> check, Context context) {
