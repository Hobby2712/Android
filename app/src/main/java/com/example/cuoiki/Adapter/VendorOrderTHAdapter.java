...
public class VendorOrderTHAdapter extends RecyclerView.Adapter<VendorOrderTHAdapter.ViewHolder> {
    List<Order> orders, check;
    Context context;
    APIService apiService;

    public VendorOrderTHAdapter(List<Order> check, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.status.setText("Trả hàng");
