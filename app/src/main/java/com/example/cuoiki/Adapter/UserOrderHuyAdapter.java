...
public class UserOrderHuyAdapter extends RecyclerView.Adapter<UserOrderHuyAdapter.ViewHolder> {
    List<Order> orders, check;
    Context context;

    public UserOrderHuyAdapter(List<Order> check, Context context) {
