...
public class XacNhanShipperAdapter extends RecyclerView.Adapter<XacNhanShipperAdapter.ViewHolder> {
    List<Order> orders;
    Context context;
    APIService apiService;

    public XacNhanShipperAdapter(List<Order> orders, Context context) {
        this.orders = orders;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.nextAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                apiService.changeStatus(order.getId(),2).enqueue(new Callback<OrderResponse>() {
                    @Override
